...
export const PrivacyData = [
    ...
    },
    {
        ...
        modifiedContent: [{
            ...
            nestedContent: [
                "Site (www.fabmerce.in) operation and app operation",
